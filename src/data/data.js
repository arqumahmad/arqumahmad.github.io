...
const experience = [
  ...
  {
    role: 'Digital Factory Specialist – Future Aircraft Technology Lab',
    org: 'Leonardo S.p.A',
  ...
  },
  {
    ...
    bullets: [
      'Built a Smart Manufacturing startup; acquired multiple OEM customers and achieved a successful exit.',
      'Developed a cloud IIoT & Predictive Maintenance platform improving efficiency (+10%) and uptime (+15%).',
      'Secured seed funding from Govt. of India (MeitY).' 
    ]
  }
];

const events = [
  { title: '3rd Annual Digital Twin & Smart Manufacturing Summit', date: '2025-11-26', range: '26–27 Nov 2025', city: 'Munich, Germany', role: 'Keynote Speaker' },
  { title: 'CDO Manufacturing & Logistics Exchange', date: '2025-11-03', range: '3–4 Nov 2025', city: 'Munich, Germany', role: 'Roundtable' },
  { title: 'GDS CIO Insight Summit', date: '2025-03-12', range: '12–13 Mar 2025', city: 'Noordwijk, Netherlands', role: 'Speaker' },
  { title: 'Aerospace Tech Week', date: '2025-04-01', range: '01 Apr 2025', city: 'Munich, Germany', role: 'Speaker, Panellist' },
  { title: 'CW Global Smart Manufacturing Summit', date: '2024-10-24', range: '24–25 Oct 2024', city: 'Munich, Germany', role: 'Keynote Speaker, Panellist' },
  { title: 'GBR Future Technologies WorX', date: '2024-05-16', range: '16–17 May 2024', city: 'Amsterdam, Netherlands', role: 'Keynote Speaker' },
  { title: '2nd Annual Digital Twin & Smart Manufacturing', date: '2024-02-21', range: '21–23 Feb 2024', city: 'Munich, Germany', role: 'Keynote Speaker, Panellist' },
  { title: '1st Annual Digital Twin & Smart Manufacturing', date: '2023-04-27', range: '27–28 Apr 2023', city: 'Munich, Germany', role: 'Keynote Speaker, Panellist' },
  { title: 'IoT World Congress', date: '2022-05-10', range: '10–12 May 2022', city: 'Barcelona, Spain', role: 'Delegate' }
];
